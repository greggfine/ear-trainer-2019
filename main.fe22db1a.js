...
var Sound = function () {
    function Sound() {
        ...
        this.gainSlider = document.querySelector('#gain-slider');
    }
    ...
    _createClass(Sound, [{
        ...
        value: function init() {
            ...
            setInterval(function () {
                _this.amp.gain.value = _this.gainSlider.value;
            });
            this.playSound();
        }
    }, {
...
},{"./Sound":30}],46:[function(require,module,exports) {
'use strict';
...
var GainSlider = function () {
    function GainSlider(sound) {
    ...
    _createClass(GainSlider, [{
        key: 'events',
        value: function events() {
            this.gainSlider.addEventListener('input', this.changeGain);
        }
    }, {
        key: 'changeGain',
        value: function changeGain() {
...
var _Play = require('./scripts/Play');

var _Play2 = _interopRequireDefault(_Play);

var _GainSlider = require('./scripts/GainSlider');

var _GainSlider2 = _interopRequireDefault(_GainSlider);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var playBtn = new _Play2.default();
var gainSlider = new _GainSlider2.default();

// var osc = false;
},{"./scripts/Play":37,"./scripts/GainSlider":46}],11:[function(require,module,exports) {
...
//# sourceMappingURL=/main.fe22db1a.map